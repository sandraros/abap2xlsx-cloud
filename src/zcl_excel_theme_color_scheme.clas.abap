CLASS zcl_excel_theme_color_scheme DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS load
      IMPORTING
        !io_color_scheme TYPE REF TO zif_excel_ixml_element .
    METHODS set_color
      IMPORTING
        iv_type         TYPE string
  ...
  PRIVATE SECTION.
    ...
    METHODS get_color
      IMPORTING
        !io_object      TYPE REF TO zif_excel_ixml_element
      RETURNING
...
CLASS zcl_excel_theme_color_scheme IMPLEMENTATION.
  ...
  METHOD build_xml.
    ...
    DATA: lo_color TYPE REF TO zif_excel_ixml_element.
    DATA: lo_syscolor TYPE REF TO zif_excel_ixml_element.
    DATA: lo_srgb TYPE REF TO zif_excel_ixml_element.
  ...
  METHOD get_color.
    DATA: lo_color_children TYPE REF TO zif_excel_ixml_node_list.
    DATA: lo_color_iterator TYPE REF TO zif_excel_ixml_node_iterator.
    DATA: lo_color_element TYPE REF TO zif_excel_ixml_element.
