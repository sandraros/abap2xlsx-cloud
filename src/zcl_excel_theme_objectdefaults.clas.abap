CLASS zcl_excel_theme_objectdefaults DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS load
      IMPORTING
        !io_object_def TYPE REF TO zif_excel_ixml_element .
    METHODS build_xml
      IMPORTING
  ...
  PRIVATE SECTION.
    ...
    DATA objectdefaults TYPE REF TO zif_excel_ixml_element .
ENDCLASS.
...
CLASS zcl_excel_theme_objectdefaults IMPLEMENTATION.
  ...
  METHOD build_xml.
    ...
    DATA: lo_theme_objdef TYPE REF TO zif_excel_ixml_element.
