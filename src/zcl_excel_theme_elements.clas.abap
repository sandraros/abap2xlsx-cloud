CLASS zcl_excel_theme_elements DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS load
      IMPORTING
        !io_elements TYPE REF TO zif_excel_ixml_element .
    METHODS build_xml
      IMPORTING
...
CLASS zcl_excel_theme_elements IMPLEMENTATION.
  ...
  METHOD build_xml.
    ...
    DATA: lo_theme TYPE REF TO zif_excel_ixml_element.
  ...
  METHOD load.
    DATA: lo_elements_children TYPE REF TO zif_excel_ixml_node_list.
    DATA: lo_elements_iterator TYPE REF TO zif_excel_ixml_node_iterator.
    DATA: lo_elements_element TYPE REF TO zif_excel_ixml_element.
