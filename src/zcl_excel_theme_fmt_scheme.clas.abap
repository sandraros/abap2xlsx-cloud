CLASS zcl_excel_theme_fmt_scheme DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS load
      IMPORTING
        !io_fmt_scheme TYPE REF TO zif_excel_ixml_element .
    METHODS build_xml
      IMPORTING
  ...
  PRIVATE SECTION.
    ...
    DATA fmt_scheme TYPE REF TO zif_excel_ixml_element .
    ...
    METHODS parse_string
      ...
      RETURNING VALUE(ri_node) TYPE REF TO zif_excel_ixml_node.
ENDCLASS.
...
CLASS ZCL_EXCEL_THEME_FMT_SCHEME IMPLEMENTATION.
  ...
  METHOD parse_string.
    DATA li_stream   TYPE REF TO zif_excel_ixml_istream.
    DATA li_ixml     TYPE REF TO zif_excel_ixml.
    DATA li_document TYPE REF TO zif_excel_ixml_document.
    DATA li_factory  TYPE REF TO zif_excel_ixml_stream_factory.
    DATA li_parser   TYPE REF TO zif_excel_ixml_parser.
    DATA li_istream  TYPE REF TO zif_excel_ixml_istream.

    li_ixml = zcl_excel_ixml=>create( ).
