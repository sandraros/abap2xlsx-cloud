CLASS zcl_excel_theme_font_scheme DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS load
      IMPORTING
        !io_font_scheme TYPE REF TO zif_excel_ixml_element .
    METHODS set_name
      IMPORTING
        iv_name TYPE string .
    METHODS build_xml
      IMPORTING
        !io_document TYPE REF TO zif_excel_ixml_document .
    METHODS modify_font
      IMPORTING
...
CLASS zcl_excel_theme_font_scheme IMPLEMENTATION.
  ...
  METHOD build_xml.
    DATA: lo_scheme_element TYPE REF TO zif_excel_ixml_element.
    DATA: lo_font TYPE REF TO zif_excel_ixml_element.
    DATA: lo_latin TYPE REF TO zif_excel_ixml_element.
    DATA: lo_ea TYPE REF TO zif_excel_ixml_element.
    DATA: lo_cs TYPE REF TO zif_excel_ixml_element.
    DATA: lo_major TYPE REF TO zif_excel_ixml_element.
    DATA: lo_minor TYPE REF TO zif_excel_ixml_element.
    DATA: lo_elements TYPE REF TO zif_excel_ixml_element.
  ...
  METHOD load.
    DATA: lo_scheme_children TYPE REF TO zif_excel_ixml_node_list.
    DATA: lo_scheme_iterator TYPE REF TO zif_excel_ixml_node_iterator.
    DATA: lo_scheme_element TYPE REF TO zif_excel_ixml_element.
    DATA: lo_major_children TYPE REF TO zif_excel_ixml_node_list.
    DATA: lo_major_iterator TYPE REF TO zif_excel_ixml_node_iterator.
    DATA: lo_major_element TYPE REF TO zif_excel_ixml_element.
    DATA: lo_minor_children TYPE REF TO zif_excel_ixml_node_list.
    DATA: lo_minor_iterator TYPE REF TO zif_excel_ixml_node_iterator.
    DATA: lo_minor_element TYPE REF TO zif_excel_ixml_element.
